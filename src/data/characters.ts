...
const CHARACTER_BASE: Omit<CharacterCard, "role" | "complexity" | "tags" | "shortDesc" | "battleTip">[] = [
  ...
  {id:"huiyin",name:"迴音",hp:8,atk:2,spd:3,passive:"每回合1次，我方獲得負面狀態時，可轉移給自己。",skill:{name:"回聲模仿",cost:2,cd:1,desc:"複製我方上一個可被複製且成功結算的技能，數值+1；複製傷害只能指定敵方，複製治療只能指定我方；若沒有可複製技能，改為對1敵造成2傷害。"},res:{name:"回聲",desc:"此技能費用-1。"}},
...
const CHARACTER_META: Record<string, CharacterMeta> = {
  ...
  huiyin: { role: "回聲支援", complexity: 4, tags: ["複製", "轉移", "保底"], shortDesc: "HP 與冷卻強化，複製數值 +1，目標依傷害/治療類型限制。", battleTip: "先讓隊友開出好技能；複製傷害打敵方，複製治療補我方。" },
