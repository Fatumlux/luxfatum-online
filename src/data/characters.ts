...
const CHARACTER_BASE: Omit<CharacterCard, "role" | "complexity" | "tags" | "shortDesc" | "battleTip">[] = [
  ...
  {id:"tianxun",name:"天訊",hp:7,atk:2,spd:4,passive:"回合開始時，由操作者選1名我方角色SPD+1。",skill:{name:"規則補充",cost:2,cd:2,desc:"選1項：普攻傷害+2、技能傷害+2、我方全體SPD+2、最低SPD先行動。"},res:{name:"加碼",desc:"可選2項，但天訊本回合不能防禦。"}},
...
const CHARACTER_META: Record<string, CharacterMeta> = {
  ...
  tianxun: { role: "規則主持", complexity: 4, tags: ["速度", "全局", "規則"], shortDesc: "HP、ATK 上修，規則補充改為 +2 選項。", battleTip: "回合開始先幫關鍵角色提速，再用 +2 規則改寫輸出窗口。" },
